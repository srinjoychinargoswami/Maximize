        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              ...
              'By downloading, installing, and using Kinetic, you agree to these Terms & Conditions. If you do not agree, do not use the application.',
            ),

            _buildSection(
              '2. License Grant',
              'Kinetic is open-source software licensed under the Apache 2.0 License. You are granted a non-exclusive, worldwide license to use, modify, and distribute this software in accordance with the license terms.',
            ),

            _buildSection(
              '3. User Responsibilities',
              'You agree to:\n\n'
              '• Use Kinetic only for lawful purposes\n'
            ...
            _buildSection(
              ...
              'Kinetic is provided "as is" without warranty of any kind. In no event shall we be liable for:\n\n'
            ...
            _buildSection(
              ...
              'Kinetic uses Firebase for optional sync features. By enabling sync, you agree to:\n\n'
            ...
            _buildSection(
              ...
              'We may update these Terms & Conditions at any time. Continued use of Kinetic after updates constitutes acceptance of new terms.',
            ),

            _buildSection(
              '9. Termination',
              'Your right to use Kinetic terminates automatically if you breach these terms. Upon termination:\n\n'
              '• Delete all copies of the application\n'
              '• Cease all use of Kinetic\n'
